...
export namespace Generated {
    ...
    export class Contract extends BaseContract {
        ...
        readonly tables = {
            accounts: new Tables.Accounts(this),
            stat: new Tables.Stat(this),
        }
    ...
    export namespace Tables {
        export class Accounts {
            ...
            public find = (queryParams: Types.AccountsFindQueryParams): Promise<Types.Account> =>
                this.table.find(queryParams)
            public static find = (
            ...
            public all = (): Promise<Types.Account[]> => this.table.all()
        ...
        export class Stat {
            readonly contract: Contract
            readonly table: Table
            static readonly table_name = Name.from('stat')
            static readonly fieldToIndex = {supply: {type: 'supply', index_position: 'primary'}}

            constructor(contract) {
                this.contract = contract
                this.table = Table.from({
                    name: Tables.Stat.table_name,
                    rowType: Types.Currency_stats,
                    fieldToIndex: Tables.Stat.fieldToIndex,
                    contract,
                })
            }

            public where = (
                queryParams: Types.StatWhereQueryParams,
                getTableRowsOptions: GetTableRowsOptions
            ): TableCursor => this.table.where(queryParams, getTableRowsOptions)
            public static where = (
                queryParams: Types.StatWhereQueryParams,
            ...
            public find = (queryParams: Types.StatFindQueryParams): Promise<Types.Currency_stats> =>
                this.table.find(queryParams)
            public static find = (
                queryParams: Types.AccountsFindQueryParams,
                client: APIClient
            ): Promise<Types.Currency_stats> => this.getTable(client).find(queryParams)
            ...
            public all = (): Promise<Types.Account[]> => this.table.all()
            public static all = (client: APIClient): Promise<Types.Currency_stats[]> =>
                this.getTable(client).all()
