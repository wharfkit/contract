...
export class _Decentiumorg extends Contract {
    addcategory(addcategoryParams: _Decentiumorg.types.AddcategoryParams, session: Session): Promise<TransactResult> {
        return this.call("addcategory", _Decentiumorg.types.Action_addcategory.from(addcategoryParams), session);
    }
    addmoderator(addmoderatorParams: _Decentiumorg.types.AddmoderatorParams, session: Session): Promise<TransactResult> {
        return this.call("addmoderator", _Decentiumorg.types.Action_addmoderator.from(addmoderatorParams), session);
    }
    createblog(createblogParams: _Decentiumorg.types.CreateblogParams, session: Session): Promise<TransactResult> {
        return this.call("createblog", _Decentiumorg.types.Action_createblog.from(createblogParams), session);
    }
    delcategory(delcategoryParams: _Decentiumorg.types.DelcategoryParams, session: Session): Promise<TransactResult> {
        return this.call("delcategory", _Decentiumorg.types.Action_delcategory.from(delcategoryParams), session);
    }
    deleteblog(deleteblogParams: _Decentiumorg.types.DeleteblogParams, session: Session): Promise<TransactResult> {
        return this.call("deleteblog", _Decentiumorg.types.Action_deleteblog.from(deleteblogParams), session);
    }
    delmoderator(delmoderatorParams: _Decentiumorg.types.DelmoderatorParams, session: Session): Promise<TransactResult> {
        return this.call("delmoderator", _Decentiumorg.types.Action_delmoderator.from(delmoderatorParams), session);
    }
    freezeblog(freezeblogParams: _Decentiumorg.types.FreezeblogParams, session: Session): Promise<TransactResult> {
        return this.call("freezeblog", _Decentiumorg.types.Action_freezeblog.from(freezeblogParams), session);
    }
    housekeeping(housekeepingParams: _Decentiumorg.types.HousekeepingParams, session: Session): Promise<TransactResult> {
        return this.call("housekeeping", _Decentiumorg.types.Action_housekeeping.from(housekeepingParams), session);
    }
    pinpost(pinpostParams: _Decentiumorg.types.PinpostParams, session: Session): Promise<TransactResult> {
    ...
    postedit(posteditParams: _Decentiumorg.types.PosteditParams, session: Session): Promise<TransactResult> {
        return this.call("postedit", _Decentiumorg.types.Action_postedit.from(posteditParams), session);
    }
    profile(profileParams: _Decentiumorg.types.ProfileParams, session: Session): Promise<TransactResult> {
        return this.call("profile", _Decentiumorg.types.Action_profile.from(profileParams), session);
    }
    publish(publishParams: _Decentiumorg.types.PublishParams, session: Session): Promise<TransactResult> {
        return this.call("publish", _Decentiumorg.types.Action_publish.from(publishParams), session);
    }
    publishedit(publisheditParams: _Decentiumorg.types.PublisheditParams, session: Session): Promise<TransactResult> {
        return this.call("publishedit", _Decentiumorg.types.Action_publishedit.from(publisheditParams), session);
    }
    setlinkflags(setlinkflagsParams: _Decentiumorg.types.SetlinkflagsParams, session: Session): Promise<TransactResult> {
        return this.call("setlinkflags", _Decentiumorg.types.Action_setlinkflags.from(setlinkflagsParams), session);
    }
    setprofile(setprofileParams: _Decentiumorg.types.SetprofileParams, session: Session): Promise<TransactResult> {
        return this.call("setprofile", _Decentiumorg.types.Action_setprofile.from(setprofileParams), session);
    }
    unfreezeblog(unfreezeblogParams: _Decentiumorg.types.UnfreezeblogParams, session: Session): Promise<TransactResult> {
        return this.call("unfreezeblog", _Decentiumorg.types.Action_unfreezeblog.from(unfreezeblogParams), session);
    }
    unpinpost(unpinpostParams: _Decentiumorg.types.UnpinpostParams, session: Session): Promise<TransactResult> {
        return this.call("unpinpost", _Decentiumorg.types.Action_unpinpost.from(unpinpostParams), session);
    }
    unpublish(unpublishParams: _Decentiumorg.types.UnpublishParams, session: Session): Promise<TransactResult> {
        return this.call("unpublish", _Decentiumorg.types.Action_unpublish.from(unpublishParams), session);
    }
    updatescore(updatescoreParams: _Decentiumorg.types.UpdatescoreParams, session: Session): Promise<TransactResult> {
        return this.call("updatescore", _Decentiumorg.types.Action_updatescore.from(updatescoreParams), session);
    }
}
export namespace _Decentiumorg {
    export namespace tables {
        export class blogs {
            ...
            static where(queryParams: _Decentiumorg.types.BlogsWhereQueryParams, getTableRowsOptions: GetTableRowsOptions, client: APIClient): TableCursor<_Decentiumorg.types.Blog_row> {
                const blogsTable = Table.from({ contract: Contract.from({ name: "decentiumorg", client: client }), name: "blogs", rowType: _Decentiumorg.types.Blog_row, fieldToIndex: blogs.fieldToIndex });
                return blogsTable.where(queryParams, getTableRowsOptions);
            }
            static find(queryParams: _Decentiumorg.types.BlogsFindQueryParams, client: APIClient): Promise<_Decentiumorg.types.Blog_row> {
                const blogsTable = Table.from({ contract: Contract.from({ name: "decentiumorg", client: client }), name: "blogs", rowType: _Decentiumorg.types.Blog_row, fieldToIndex: blogs.fieldToIndex });
                return blogsTable.find(queryParams);
            }
            static first(limit: number, client: APIClient): TableCursor<_Decentiumorg.types.Blog_row> {
                const blogsTable = Table.from({ contract: Contract.from({ name: "decentiumorg", client: client }), name: "blogs", rowType: _Decentiumorg.types.Blog_row, fieldToIndex: blogs.fieldToIndex });
                return blogsTable.first(limit);
            }
        }
        export class links {
            static fieldToIndex = { id: { type: "uint64", index_position: "primary" }, from: { type: "uint128", index_position: "secondary" }, to: { type: "uint128", index_position: "tertiary" } };
            static where(queryParams: _Decentiumorg.types.LinksWhereQueryParams, getTableRowsOptions: GetTableRowsOptions, client: APIClient): TableCursor<_Decentiumorg.types.Link_row> {
                const linksTable = Table.from({ contract: Contract.from({ name: "decentiumorg", client: client }), name: "links", rowType: _Decentiumorg.types.Link_row, fieldToIndex: links.fieldToIndex });
                return linksTable.where(queryParams, getTableRowsOptions);
            }
            static find(queryParams: _Decentiumorg.types.LinksFindQueryParams, client: APIClient): Promise<_Decentiumorg.types.Link_row> {
                const linksTable = Table.from({ contract: Contract.from({ name: "decentiumorg", client: client }), name: "links", rowType: _Decentiumorg.types.Link_row, fieldToIndex: links.fieldToIndex });
                return linksTable.find(queryParams);
            }
            static first(limit: number, client: APIClient): TableCursor<_Decentiumorg.types.Link_row> {
                const linksTable = Table.from({ contract: Contract.from({ name: "decentiumorg", client: client }), name: "links", rowType: _Decentiumorg.types.Link_row, fieldToIndex: links.fieldToIndex });
                return linksTable.first(limit);
            }
        }
        export class posts {
            static fieldToIndex = { slug: { type: "name", index_position: "primary" }, updated: { type: "uint64", index_position: "secondary" } };
            static where(queryParams: _Decentiumorg.types.PostsWhereQueryParams, getTableRowsOptions: GetTableRowsOptions, client: APIClient): TableCursor<_Decentiumorg.types.Post_row> {
                const postsTable = Table.from({ contract: Contract.from({ name: "decentiumorg", client: client }), name: "posts", rowType: _Decentiumorg.types.Post_row, fieldToIndex: posts.fieldToIndex });
                return postsTable.where(queryParams, getTableRowsOptions);
            }
            static find(queryParams: _Decentiumorg.types.PostsFindQueryParams, client: APIClient): Promise<_Decentiumorg.types.Post_row> {
                const postsTable = Table.from({ contract: Contract.from({ name: "decentiumorg", client: client }), name: "posts", rowType: _Decentiumorg.types.Post_row, fieldToIndex: posts.fieldToIndex });
                return postsTable.find(queryParams);
            }
            static first(limit: number, client: APIClient): TableCursor<_Decentiumorg.types.Post_row> {
                const postsTable = Table.from({ contract: Contract.from({ name: "decentiumorg", client: client }), name: "posts", rowType: _Decentiumorg.types.Post_row, fieldToIndex: posts.fieldToIndex });
        ...
        export class state {
            static fieldToIndex = {};
            static where(queryParams: _Decentiumorg.types.StateWhereQueryParams, getTableRowsOptions: GetTableRowsOptions, client: APIClient): TableCursor<_Decentiumorg.types.State> {
                const stateTable = Table.from({ contract: Contract.from({ name: "decentiumorg", client: client }), name: "state", rowType: _Decentiumorg.types.State, fieldToIndex: state.fieldToIndex });
                return stateTable.where(queryParams, getTableRowsOptions);
            }
            static find(queryParams: _Decentiumorg.types.StateFindQueryParams, client: APIClient): Promise<_Decentiumorg.types.State> {
                const stateTable = Table.from({ contract: Contract.from({ name: "decentiumorg", client: client }), name: "state", rowType: _Decentiumorg.types.State, fieldToIndex: state.fieldToIndex });
        ...
        export class trending {
            static fieldToIndex = { id: { type: "uint64", index_position: "primary" }, score: { type: "uint64", index_position: "secondary" }, cscore: { type: "uint128", index_position: "tertiary" }, permlink: { type: "uint128", index_position: "fourth" } };
            static where(queryParams: _Decentiumorg.types.TrendingWhereQueryParams, getTableRowsOptions: GetTableRowsOptions, client: APIClient): TableCursor<_Decentiumorg.types.Trending_row> {
                const trendingTable = Table.from({ contract: Contract.from({ name: "decentiumorg", client: client }), name: "trending", rowType: _Decentiumorg.types.Trending_row, fieldToIndex: trending.fieldToIndex });
                return trendingTable.where(queryParams, getTableRowsOptions);
            }
            static find(queryParams: _Decentiumorg.types.TrendingFindQueryParams, client: APIClient): Promise<_Decentiumorg.types.Trending_row> {
                const trendingTable = Table.from({ contract: Contract.from({ name: "decentiumorg", client: client }), name: "trending", rowType: _Decentiumorg.types.Trending_row, fieldToIndex: trending.fieldToIndex });
                return trendingTable.find(queryParams);
            }
            static first(limit: number, client: APIClient): TableCursor<_Decentiumorg.types.Trending_row> {
                const trendingTable = Table.from({ contract: Contract.from({ name: "decentiumorg", client: client }), name: "trending", rowType: _Decentiumorg.types.Trending_row, fieldToIndex: trending.fieldToIndex });
