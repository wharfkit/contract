        ...
        export class blogs {
            ...
            static where(
                ...
                const blogsTable = Table.from({
                    contract: Contract.from({name: 'decentiumorg', client: client}),
                    name: 'blogs',
...
export namespace _Decentiumorg {
    export namespace types {
        ...
        export class Document extends Struct {
            ...
            declare content:
                | _Decentiumorg.types.Paragraph
                | _Decentiumorg.types.Heading
                | _Decentiumorg.types.Image
                | _Decentiumorg.types.Linkref
                | _Decentiumorg.types.Quote
                | _Decentiumorg.types.Code_block
                | _Decentiumorg.types.Divider
                | _Decentiumorg.types.List
        }
        ...
        export class Image extends Struct {
            ...
            declare caption: _Decentiumorg.types.Text | _Decentiumorg.types.Hard_break
            @Struct.field('layout')
        ...
        export class Image_info extends Struct {
            ...
            declare placeholder:
                | _Decentiumorg.types.Color
                | _Decentiumorg.types.Geometrize_triangles
        }
        @Struct.type('italic')
        ...
        export class List_item extends Struct {
            @Struct.field('content')
            declare content: _Decentiumorg.types.Text | _Decentiumorg.types.Hard_break
        }
        ...
        export class Text extends Struct {
            ...
            @Struct.field('marks')
            declare marks:
                | _Decentiumorg.types.Link
                | _Decentiumorg.types.Bold
                | _Decentiumorg.types.Italic
                | _Decentiumorg.types.Code
                | _Decentiumorg.types.Strike
        }
